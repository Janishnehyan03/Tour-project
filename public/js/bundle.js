      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              (0, _alerts.showAlert)('dark', 'logged out successfully');
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiamFuaXNobmVoeWFuMDMiLCJhIjoiY2t0YXlpdWZlMWs1bjJ1cGMxZDltN3hzeiJ9.pBorchZzN28cBWovhnm_xQ';
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe("pk_test_51JZZ7eSAxKBwoS4hffwoy2M638J4YZNlp8UbwOsNCp0o9S29l4ulhXRVckqnxg0NFoKYNWz54JYWjeVllfcwBIfr00rtQbnFaT"); // 1) Get session from server
...
var bookBtn = document.getElementById("rzp-button1"); // DELEGATIONS
...
if (userPasswordForm) {
  userPasswordForm.addEventListener("submit", /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
      var currentPassword, passwordConfirm, password;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
